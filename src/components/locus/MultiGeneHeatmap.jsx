...
function MultiGeneHeatmap({
      ...
      <div className="multi-gene-heatmap-overlay">
        <div className="multi-gene-heatmap-modal">
          <div className="multi-gene-heatmap-header">
            <h3>Expression Profiles Heatmap</h3>
  ...
  const headerContent = (
    <div className={`multi-gene-heatmap-header ${inline ? 'inline-header' : ''}`}>
      {!inline && <h3>Expression Profiles Heatmap</h3>}
          ...
          <div className="heatmap-gene-labels">
            <div className="heatmap-corner">
              ...
              <div className="corner-correlation-label">
                <span className="correlation-info-icon">
                  i
                  <span className="correlation-tooltip">
                    Pearson correlation (r) measures similarity between expression profiles.
                    Values: -1 (opposite) to +1 (same pattern).
                    Number in parentheses = conditions used.
                  </span>
                </span>
              </div>
            </div>
