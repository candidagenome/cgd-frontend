        ...
        <div className="info-section">
          <div className="help-item">
            ...
            <div className="help-links">
              <Link to="/download/go/gene_association.cgd.gz">Download the File</Link>
              <Link to="/download/go/gene_association_README.txt">View the README</Link>
            </div>
          </div>
          ...
          <div className="help-item">
            ...
            <div className="help-links">
              <Link to="/download/chromosomal_feature_files/">Go to the Chromosomal Feature File Directory</Link>
              <Link to="/download/chromosomal_feature_files/README">View the README</Link>
            </div>
          </div>
          ...
          <div className="help-item">
            ...
            <div className="help-links">
              <Link to="/download/sequence/">Go to the Sequence Download Directory</Link>
              <Link to="/download/sequence/README">View the README</Link>
            </div>
          </div>
          ...
          <div className="help-item">
            ...
            <div className="help-links">
              <Link to="/download/phenotype/">Go to the Directory</Link>
              <Link to="/download/phenotype/README">View the README</Link>
            </div>
          </div>
          ...
          <div className="help-item">
            ...
            <div className="help-links">
              ...
              <Link to="/download/systematic_results">Browse the Download Directory</Link>
            </div>
          </div>
          ...
          <div className="help-item">
            ...
            <div className="help-links">
              <Link to="/download/Assembly21notes/">Go to the Directory</Link>
              <Link to="/download/Assembly21notes/README">View the README</Link>
            </div>
          </div>
          ...
          <div className="help-item">
            ...
            <div className="help-links">
              <Link to="/download/Assembly20notes/">Go to the Directory</Link>
              <Link to="/download/Assembly20notes/README">View the README</Link>
            </div>
          </div>
          ...
          <div className="help-item">
            ...
            <div className="help-links">
              <Link to="/download/Assembly19notes/A19graphs-pdf.tar.gz">Download the Files</Link>
              <Link to="/download/Assembly19notes/README">View the README</Link>
            </div>
          </div>
          ...
          <div className="help-item">
            ...
            <div className="help-links">
              <Link to="/download/External_id_mappings">Download the Files</Link>
              <Link to="/download/External_id_mappings/README">View the README</Link>
            </div>
          </div>
          ...
          <div className="help-item">
            ...
            <div className="help-links">
              <Link to="/download/mapping_historic_assemblies/">Go to the Directory</Link>
              <Link to="/download/mapping_historic_assemblies/README">View the README</Link>
            </div>
          </div>
          ...
          <div className="help-item">
            ...
            <div className="help-links">
              <Link to="/download/mapping_historic_assemblies/orf19_orf6_mapping.txt">Download the File</Link>
              <Link to="/download/mapping_historic_assemblies/orf19_orf6_mapping_README.txt">View the README</Link>
            </div>
          </div>
          ...
          <div className="help-item">
            ...
            <div className="help-links">
              <Link to="/download/mapping_historic_assemblies/orf4_orf19_mapping.txt">Download the File</Link>
              <Link to="/download/mapping_historic_assemblies/orf4_orf19_mapping_README.txt">View the README</Link>
            </div>
          </div>
          ...
          <div className="help-item">
            ...
            <div className="help-links">
              <Link to="/download/gff">Go to the Directory</Link>
              <Link to="/download/gff/README">View the README</Link>
            </div>
          </div>
          ...
          <div className="help-item">
            ...
            <div className="help-links">
              <Link to="/download/homology/orthologs/">Go to the Orthologs Directory</Link>
              <Link to="/download/homology/best_hits/">Go to the Best Hits Directory</Link>
            </div>
          </div>
          ...
          <div className="help-item">
            ...
            <div className="help-links">
              <Link to="/download/pathways/">Go to the Pathways Directory</Link>
              <Link to="/download/pathways/README">View the README</Link>
            </div>
          </div>
          ...
          <div className="help-item">
            ...
            <div className="help-links">
              <Link to="/download/domains/">Go to the Domains Directory</Link>
              <Link to="/download/domains/README">View the README</Link>
            </div>
          </div>
          ...
          <div className="help-item">
            ...
            <div className="help-links">
              <Link to="/download/misc/C_albicans_codon_usage.tab">View the File and README</Link>
            </div>
          </div>
          ...
          <div className="help-item">
            ...
            <div className="help-links">
              <Link to="/download/misc/">Go to the Directory</Link>
              <Link to="/download/misc/README">View the README</Link>
            </div>
          </div>
          ...
          <div className="help-item">
            ...
            <div className="help-links">
              <Link to="/download/go/go_slim/goslim_candida.obo">View the obo file</Link>
            </div>
          </div>
          ...
          <div className="help-item">
            ...
            <p>
              The GOslim_gene_association.cgd file contains GO Slim annotations for CGD genes, using the <Link to="/download/go/go_slim/goslim_candida.obo">CGD GO Slim</Link> instead of the entire <a href="http://wiki.geneontology.org/index.php/GO_FAQ" target="_blank" rel="noopener noreferrer">Gene Ontology</a>. A <a href="http://www.geneontology.org/GO.slims.shtml" target="_blank" rel="noopener noreferrer">GO Slim</a> is a small subset of terms from the Gene Ontology, which is intended to provide a general overview without all the fine-grained detail contained in the GO itself. For the actual CGD GO curation, please use the <Link to="/download/go/gene_association_README.txt">gene_association.cgd</Link> file.
            </p>
            <div className="help-links">
              <Link to="/download/go/go_slim/GOslim_gene_association.cgd.gz">Download the File</Link>
              <Link to="/download/go/go_slim/GOslim_gene_association_README.txt">View the README</Link>
            </div>
          </div>
          ...
          <div className="help-item">
            ...
            <div className="help-links">
              <Link to="/download/">Go to the top-level directory</Link>
            </div>
          </div>
        </div>
      </div>
