...
==============================================
Parses HISAT2 alignment logs and updates metadata TSV with alignment percentages.

Usage:
    python extract_alignment_stats.py <metadata.tsv> <logs_dir> [--output <output.tsv>]

Example:
    python extract_alignment_stats.py Iracane_2021_metadata.tsv /data/tmp/aligned/
    python extract_alignment_stats.py Iracane_2021_metadata.tsv ./logs --output updated_metadata.tsv
...
def main():
    parser = argparse.ArgumentParser(
        description='Extract alignment stats from HISAT2 logs and update metadata TSV',
        formatter_class=argparse.RawDescriptionHelpFormatter,
        epilog='''
Examples:
  python extract_alignment_stats.py metadata.tsv /data/tmp/aligned/
  python extract_alignment_stats.py metadata.tsv ./logs --output updated.tsv
        '''
    )
    ...
    parser.add_argument('--output', '-o', help='Output TSV path (default: update in place)')
    ...
    summary = update_metadata_tsv(args.metadata_tsv, args.logs_dir, args.output)

    output_file = args.output or args.metadata_tsv
    print()
