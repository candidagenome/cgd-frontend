      ...
      <div className="info-page-content">
        ...
        <div className="info-section">
          ...
          <ul>
            ...
            <li><a href="#coexpression">Expression Profiles Sub-tab</a></li>
        ...
        <div className="info-section">
          ...
          <ul>
            ...
            <li><strong>Expression Profiles</strong> - Identifies genes with correlated expression patterns (similar genes analysis)</li>
          </ul>
        </div>
        ...
        <div className="info-section">
          ...
          <ul>
            ...
            <li>Both Expression Data and Expression Profiles sub-tabs stay synchronized to the selected organism</li>
          </ul>
        ...
        <div className="info-section">
          <h2 id="coexpression">Expression Profiles Sub-tab</h2>
          <p>
            The Expression Profiles sub-tab identifies genes with similar expression profiles to your gene
          ...
          <ul>
            ...
            <li>
              ...
              Genes are sorted by correlation strength (highest first).
            </li>
            <li>
              <strong>View</strong> - Toggle between Heatmap and Table display modes.
            </li>
          </ul>
        ...
        <div className="info-section">
          ...
          <p>
            Both the Expression Data heatmap strip and the Expression Profiles heatmap use the same
...
{`fold_change = (condition_coverage × control_library_size) / (control_coverage × condition_library_size)`}
        ...
        <div className="info-section">
          ...
          <p>
            <strong>Correlated genes</strong> (genes with similar expression patterns) may:
          </p>
          <ul>
          ...
          <p>
            ...
            between gene expression profiles. Correlation values range from 0 to +1 for
          ...
          <p>
            Generally, correlations above 0.8 are considered strong and biologically meaningful.
          </p>
          ...
          <ul>
            <li>
              Look for <strong>r &gt; 0.8</strong> and low p-values (&lt;0.001)
